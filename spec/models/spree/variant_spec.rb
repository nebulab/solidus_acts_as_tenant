...
describe Spree::Variant, set_tenant: true do
  describe '#shipping_category' do
    ...
    it 'does not raise an error when accessing shipping_category' do
      expect { variant.shipping_category }.not_to raise_error
    end
    ...
    it 'does not raise an error when #shipping_category_id is called' do
      expect { variant.shipping_category_id }.not_to raise_error
    end
